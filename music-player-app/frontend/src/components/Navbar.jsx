                            ...
                            <>
                                ...
                                >
                                    ...
                                    <div className="text-left hidden md:block">
                                        <p className="text-[9px] text-purple-400 font-black uppercase tracking-[0.2em] leading-none mb-1">PRO_DATA</p>
                                        <p className="text-sm font-black text-white leading-none uppercase tracking-tight">{user.name}</p>
                                    </div>
                                </button>

                                {showDropdown && (
                                    <div
                                        className="absolute right-0 mt-4 w-72 bg-gray-900/95 backdrop-blur-2xl rounded-[2.5rem] border border-purple-500/20 shadow-[0_25px_70px_rgba(0,0,0,0.6)] overflow-hidden animate-in fade-in zoom-in-95 duration-300 z-[60]">


                                        <div
                                            className="p-6 bg-gradient-to-b from-purple-500/10 to-transparent border-b border-purple-500/10">
                                            <div className="flex items-center gap-4 mb-1">
                                                <div
                                                    className="w-12 h-12 rounded-2xl bg-purple-600 flex items-center justify-center text-xl font-black text-white shadow-[0_0_15px_rgba(168,85,247,0.4)] border border-purple-400/30">
                                                    {user.name?.charAt(0)}
                                                </div>
                                        ...
                                        <div className="p-3 space-y-2">
                                            ...
                                            <button
                                                className="w-full group flex items-center gap-4 px-4 py-4 rounded-[1.8rem] text-gray-400 hover:text-white hover:bg-white/5 transition-all duration-300 text-left">
                                                <div
                                                    className="w-10 h-10 rounded-xl bg-purple-500/10 flex items-center justify-center group-hover:bg-purple-500/20 group-hover:text-purple-400 transition-colors border border-purple-500/10">
                                                ...
                                                <span
                                                    className="text-[9px] bg-purple-500/20 text-purple-400 px-2 py-1 rounded-lg font-black tracking-tighter">SOON</span>
                                            </button>

                                            <div
                                                className="w-full flex flex-col gap-2 px-4 py-3 rounded-[1.8rem] bg-purple-500/5 border border-purple-500/10">
                                            ...
                                            >
                                                <div
                                                    className="w-10 h-10 rounded-xl bg-gray-800/40 flex items-center justify-center group-hover:bg-red-500/20 transition-colors border border-white/5">
                                                <span
                                                    className="text-lg group-hover:-translate-x-1 transition-transform">↪</span>
                                                </div>
                                                <div className="flex-1">
                                        ...
                                        <div
                                            className="px-6 py-4 bg-purple-900/20 flex justify-between items-center border-t border-purple-500/10">
                                        <span
                                            className="text-[9px] font-bold text-purple-300/40 uppercase tracking-widest">MusicNote v1.0</span>
                                            <div className="flex gap-1">
                                                <div
                                                    className="w-1.5 h-1.5 rounded-full bg-purple-500 animate-pulse shadow-[0_0_8px_rgba(168,85,247,0.8)]"></div>
                                            </div>
                                        </div>
                                    </div>
                                )}
