...
export default function Navbar({
  ...
  return (
    <nav className="w-full bg-black/20 backdrop-blur-xl px-8 py-4 flex items-center justify-between sticky top-0 z-50 border-b border-purple-500/10 shadow-2xl">
      

      <div className="flex items-center gap-3 group cursor-pointer">
        <div className="w-10 h-10 bg-purple-600 rounded-xl flex items-center justify-center shadow-[0_0_15px_rgba(168,85,247,0.4)] group-hover:rotate-12 transition-transform duration-300 border border-purple-400/30">
          <span className="text-white text-2xl">♪</span>
        </div>
        <span className="text-2xl font-black tracking-tighter bg-gradient-to-r from-white via-purple-200 to-purple-400 bg-clip-text text-transparent italic uppercase">
          MusicNote
        </span>
      </div>
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="relative group" ref={inputRef}>
          <input
            ...
            `}
          />
          <div className={`absolute right-4 top-1/2 -translate-y-1/2 transition-colors duration-300 ${isSearchFocused ? 'text-purple-400' : 'text-gray-500'}`}>
        ...
        <div className="relative" ref={dropdownRef}>
          {user ? (
            <>
              ...
              >
                <div className="w-10 h-10 bg-purple-600 rounded-full flex items-center justify-center font-black text-white shadow-[0_0_10px_rgba(168,85,247,0.3)] group-hover:scale-105 transition-transform duration-300 border border-purple-400/30">
  ...
  <div className="absolute right-0 mt-4 w-72 bg-gray-900/95 backdrop-blur-2xl rounded-[2.5rem] border border-purple-500/20 shadow-[0_25px_70px_rgba(0,0,0,0.6)] overflow-hidden animate-in fade-in zoom-in-95 duration-300 z-[60]">
    ...
    <div className="p-6 bg-gradient-to-b from-purple-500/10 to-transparent border-b border-purple-500/10">
      <div className="flex items-center gap-4 mb-1">
        <div className="w-12 h-12 rounded-2xl bg-purple-600 flex items-center justify-center text-xl font-black text-white shadow-[0_0_15px_rgba(168,85,247,0.4)] border border-purple-400/30">
          {user.name?.charAt(0)}
        </div>
    ...
    <div className="p-3 space-y-2">
      ...
      >
        <div className="w-10 h-10 rounded-xl bg-gray-800/40 flex items-center justify-center group-hover:bg-red-500/20 transition-colors border border-white/5">
