                    ...
                    <div className="relative" ref={dropdownRef}>
                        {user ? (
                            <>
                                ...
                                {showDropdown && (
                                    <div className="absolute right-0 mt-4 w-72 bg-gray-900/95 backdrop-blur-2xl
                                        ...
                                        <div
                                            className="p-6 bg-gradient-to-b from-purple-500/10 to-transparent
                                        ...
                                        <div className="p-3 space-y-2">
                                            <button
                                                className="w-full group flex items-center gap-4 px-4 py-4
                                                    rounded-[1.8rem] text-gray-400 hover:text-white hover:bg-white/5
                                                    transition-all duration-300 text-left"
                                            >
                                                <div className="w-10 h-10 rounded-xl bg-purple-500/10 flex items-center
                                                    justify-center group-hover:bg-purple-500/20
                                                    group-hover:text-purple-400 transition-colors border
                                                ...
                                                <span className="text-[9px] bg-purple-500/20 text-purple-400 px-2 py-1
                                                rounded-lg font-black tracking-tighter">SOON</span>
                                            </button>

                                            <div className="w-full flex flex-col gap-2 px-4 py-3 rounded-[1.8rem]
                                                bg-purple-500/5 border border-purple-500/10">
                                                <p className="text-[9px] font-black text-purple-400/60 uppercase
                                                    tracking-[0.2em] ml-1">
                                        ...
                                        <div className="px-6 py-4 bg-purple-900/20 flex justify-between items-center
                                            border-t border-purple-500/10">
                                        <span className="text-[9px] font-bold text-purple-300/40 uppercase
                                            tracking-widest">MusicNote v1.0</span>
                            ...
                            <button
                                ...
                                className="bg-transparent border border-purple-500/50 text-purple-400
                                    font-black py-2.5 px-8 rounded-xl transition-all duration-300 hover:bg-purple-600
                                    hover:text-white hover:shadow-[0_0_20px_rgba(168,85,247,0.3)] active:scale-95
