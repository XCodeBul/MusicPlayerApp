        ...
        <div className="fixed inset-0 z-[1000000] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md bg-gray-950 border border-purple-500/20 rounded-[3rem]
                ...
                <div className="space-y-4 relative z-10">
                    ...
                    <button
                        ...
                        className="w-full bg-transparent border border-purple-500 text-purple-400 hover:bg-purple-600
                            ...
                            transition-all active:scale-95 uppercase text-xs tracking-[0.3em]"
                    >
                ...
                <div className="grid grid-cols-2 gap-4 relative z-10">
                    <button
                        onClick={handleEmailAuth}
                        className="flex items-center justify-center gap-3 bg-white/5 border border-purple-500/10
                            hover:border-purple-500/40 py-3 rounded-2xl transition-all group"
                    >
                        <span className="text-xs font-black text-purple-300/40 group-hover:text-purple-400 uppercase
                            tracking-widest transition-colors">Spotify</span>
                    </button>
                    <button
                ...
                <div className="mt-12 flex justify-center relative z-10">
                    ...
                    >
                        ...
                        <span className="text-xs font-black uppercase tracking-[0.2em] text-white border-b
                                border-purple-500/50 group-hover:border-purple-500 transition-all">
