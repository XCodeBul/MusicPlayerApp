    ...
    return (
        <>
            <div className="mb-2 lg:mb-8 py-3 md:py-0 flex items-center justify-between shrink-0">
                <h3 className="text-lg md:text-2xl font-black text-white uppercase tracking-tighter flex items-center
                    gap-3">
            ...
            <div className={'h-[270px] overflow-y-auto custom-scrollbar'}>
                {selectedPlaylist && selectedPlaylist.songs.length > 0 ? (
                        ...
                        {selectedPlaylist.songs.map((song) => (
                            <li
                                ...
                                className={`flex items-center gap-5 p-4 rounded-2xl cursor-pointer transition-all 
                                    duration-300 group relative border ${
                                ...
                                <div className="relative">
                                    {song.albumArt ? (
                                        <img src={song.albumArt}
                                             className="w-12 h-12 rounded-xl shadow-lg group-hover:scale-105
                                                transition-transform object-cover"
                                             alt=""/>
                                    ) : (
                                        <div className="w-12 h-12 bg-gradient-to-br from-purple-600 to-purple-900
                                ...
                                <div className="flex items-center gap-3">
                                    {currentSong?.id === song.id && (
                                        <div className="flex gap-[2px] items-end h-3 mr-2">
                                            <div className="w-[2px] bg-purple-500 animate-[bounce_1s_infinite_0.1s]
                                                h-full"></div>
                                            <div className="w-[2px] bg-purple-500 animate-[bounce_1.2s_infinite_0.3s]
                                                h-2/3"></div>
                                            <div className="w-[2px] bg-purple-500 animate-[bounce_0.8s_infinite_0.2s]
                                                h-1/2"></div>
                                        </div>
                                    )}
                                    ...
                                    <button
                                        ...
                                        className="opacity-100 lg:opacity-0 group-hover:opacity-100 p-1.5 bg-red-500/10
                                            lg:bg-transparent hover:bg-red-500/20 text-red-500 lg:text-gray-500
                                            lg:hover:text-red-500 rounded-lg transition-all duration-200 z-10"
                                    >
                                    ...
                                    <span className="text-[10px] text-purple-400 font-black tracking-widest opacity-50
                                        uppercase">30s</span>
                                </div>
                            </li>
                        ))}
                    ...
                    <div className="text-center py-6 xl:py-10 lg:py-24 flex flex-col items-center justify-center
                        opacity-40">
                        <div className="w-16 h-16 rounded-full border border-purple-500/20 flex items-center
                            justify-center mb-4">
