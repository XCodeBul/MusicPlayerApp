...
const PlaylistManager = () => {
    ...
    // Локално състояние за модала и тултипа
    ...
    return (
        <div className="flex flex-col h-full relative border-r border-purple-500/10">
                        ...
                        return (
                            <div
                                ...
                                onClick={() => {
                                    ...
                                    setCurrentSong(null); // Нулираме песента при смяна на плейлиста
                                    logPlaylistView(playlist.id); // Записваме преглеждането
                                }}
                                onMouseEnter={(e) => {
                                    // Изчисляваме позицията на тултипа спрямо иконката
                            ...
                            >
                                ...
                                {/* Индикаторна линия за активност (отляво) */}
                                {isActive && (
            ...
            {/* Външни компоненти за управление */}
