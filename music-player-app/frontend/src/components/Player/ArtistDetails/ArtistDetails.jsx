...
const ArtistDetails = ({currentSong}) => {
    ...
    if (loading) return (
        <div
            className="text-gray-400 p-10 animate-pulse text-center w-full font-bold text-xl tracking-tighter">
    ...
    return (
        ...
        duration-500 overflow-hidden">
            <div className="relative shrink-0">
                ...
                <div
                    className="absolute -top-3 -left-3 bg-purple-600 text-white text-[10px] font-black px-3 py-1.5
                    rounded-xl shadow-lg border border-white/20 uppercase tracking-widest">
            ...
            <div className="flex flex-col justify-center flex-1 space-y-6 min-w-0">
                ...
                <div className="flex items-start xl:gap-3 lg:gap-12">
                    <div className="space-y-1">
                        ...
                        <p className="text-[11px] text-gray-500 uppercase font-bold tracking-widest text-nowrap">
                            {t.inTheWorld}
                        </p>
                    </div>

                    <div className="space-y-1 border-l border-white/10 xl:pl-3 lg:pl-12">
                        <p className="xl:text-2xl lg:text-4xl font-black text-purple-400 leading-none">
                    ...
                    <div className="space-y-1 border-l border-white/10 xl:pl-3 lg:pl-12">
                        <p className="xl:text-2xl lg:text-4xl font-black text-white leading-none">
                            {monthlyListeners}
                        </p>
                        <p className="text-[11px] text-gray-500 uppercase font-bold tracking-widest text-nowrap">
                            {t.monthlyListenersTitle}
                        </p>
                    </div>
                </div>
                ...
                <div className="max-w-3xl">
                    <p className="text-gray-400 text-sm leading-relaxed line-clamp-3 italic">
                        {artist.name} {t.artistBio} <span
                        className="text-gray-300 font-bold not-italic">{genresList}</span>.
                        {" "}{t.monthlyPart} {monthlyListeners} {t.listenersPart}
                        {artist.followers.total.toLocaleString()} {t.followersPart}
                    </p>
                </div>
                ...
                <div className="space-y-4">
                    {topCities.map((city, idx) => (
                        <div key={idx} className="flex justify-between items-center group">
                            <span
                                className="text-sm text-gray-300 font-bold group-hover:text-purple-400
                                transition-colors">{city.name}</span>
